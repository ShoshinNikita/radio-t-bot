...
const wrongCommandText = "Неверная команда"
const wrongCommandTTS = "Неверная команда. Может, подойдёт что-то из этого?"

const botInfoText = "Это бот для еженедельного HiTech подкаста Радио-Т. Он позволяет узнать:\n* через сколько будет следующий выпуск;\n* информацию о последнем выпуске.\n\nЧто вы хотите узнать?"
const botInfoTTS = "Это бот для еженедельного Х+айТ+эк падкаста Радио-Т.\nЧто вы хотите узнать?"
